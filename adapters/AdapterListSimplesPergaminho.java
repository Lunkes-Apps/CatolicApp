 ...
 */
public class AdapterListSimplesPergaminho extends BaseAdapter {
    ...
    public AdapterListSimplesPergaminho(Context context, ArrayList<String> lista) {
        this.lista = lista;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = inflater.inflate(R.layout.item_list_simples_pergaminho,null);
        ...
        suportItemLivro.texto.setText(lista.get(position));
